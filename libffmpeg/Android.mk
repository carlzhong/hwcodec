...
AVCODEC_C_FILES-$(CONFIG_LIBFDKAAC_ENCODER)  += libfdk-aacenc.c  
...
PROG_C_FILES-$(CONFIG_FFMPEG) += ffmpeg.c cmdutils.c #realtimeEnc.c
...
$(LOCAL_PATH)/../fdk-aac-0.1.1/libAACenc/include  $(LOCAL_PATH)/../fdk-aac-0.1.1/libSYS/include
#LOCAL_STATIC_LIBRARIES := libx264
#LOCAL_LDFLAGS+=$(LOCAL_PATH)/../x264/libx264.a       $(LOCAL_PATH)/../../obj/local/armeabi/libopencore-amrnb.a
...
LOCAL_C_INCLUDES+=$(LOCAL_PATH)/../x264/include   $(LOCAL_PATH)/../faac-1.28/include  $(LOCAL_PATH)/../opencoreamr
#LOCAL_STATIC_LIBRARIES := libx264 
LOCAL_LDFLAGS+= $(LOCAL_PATH)/../../obj/local/armeabi/libopencore-amrnb.a  \
/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/libs/armeabi-v7a/libsupc++.a \
$(LOCAL_PATH)/../../obj/local/armeabi/libFraunhoferAAC.a   #$(LOCAL_PATH)/../x264/libx264.a     
...
TARGET_ARCH_ABI := armeabi-v7a
LOCAL_CFLAGS += -march=armv7-a
LOCAL_MODULE := libhwffmpeg_neon  #libffmpeg_neon
