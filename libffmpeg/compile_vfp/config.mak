...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-cross-compile --target-os=linux --arch=arm --cross-prefix=/D/sourceCode/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi- --extra-cflags='-mfpu=vfp -mfloat-abi=softfp -fPIC' --disable-logging --enable-gpl --enable-version3 --enable-nonfree --disable-doc --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-postproc --enable-small --enable-fastdiv --disable-encoders --disable-decoders --enable-decoder=png --enable-decoder=h263 --enable-decoder=h263i --enable-decoder=mpeg4 --enable-decoder=mjpeg --enable-decoder=jpeg2000 --enable-decoder=pcm_s16le --enable-decoder=zlib --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=aasc --enable-decoder=ac3 --enable-decoder=mp3 --enable-decoder=amrnb --enable-decoder=amrwb --enable-encoder=aac --enable-encoder=ac3 --enable-encoder=h263 --enable-encoder=pcm_s16le --enable-encoder=mjpeg --enable-encoder=jpeg2000 --enable-encoder=png --enable-encoder=zlib --disable-hwaccels --disable-muxers --disable-demuxers --enable-demuxer=mov --enable-demuxer=applehttp --enable-demuxer=h263 --enable-demuxer=mpegts --enable-demuxer=aac --enable-demuxer=ac3 --enable-demuxer=amr --enable-demuxer=mp3 --enable-demuxer=image2 --enable-demuxer=image2pipe --enable-demuxer=mjpeg --enable-demuxer=pcm_s16le --enable-muxer=ac3 --enable-muxer=adts --enable-muxer=image2 --enable-muxer=mjpeg --enable-muxer=mp4 --enable-muxer=mpegts --enable-muxer=mov --enable-muxer=tgp --enable-muxer=pcm_s16le --enable-muxer=rawvideo --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=ac3 --enable-parser=h263 --enable-parser=mjpeg --enable-parser=mpeg4video --enable-parser=mpegvideo --enable-parser=mpegaudio --disable-protocols --enable-protocol=applehttp --enable-protocol=http --enable-protocol=tcp --enable-protocol=udp --enable-protocol=concat --enable-protocol=file --enable-protocol=pipe --disable-filters --enable-filter=abuffer --enable-filter=abuffersink --enable-filter=aconvert --enable-filter=aformat --enable-filter=amerge --enable-filter=amovie --enable-filter=aresample --enable-filter=color --enable-filter=copy --enable-filter=crop --enable-filter=fade --enable-filter=fifo --enable-filter=format --enable-filter=lutrgb --enable-filter=movie --enable-filter=negate --enable-filter=overlay --enable-filter=pad --enable-filter=scale --enable-filter=select --enable-filter=thumbnail --enable-filter=transpose --enable-filter=unsharp --enable-filter=volume --disable-decoder=vp8 --disable-devices --disable-debug --disable-stripping --disable-bzlib --enable-asm --enable-sram --enable-pthreads --extra-ldflags='-L/D/sourceCode/android-ndk-r8b/platforms/android-8/arch-arm/usr/lib -nostdlib' --enable-armvfp
prefix=/usr/local
