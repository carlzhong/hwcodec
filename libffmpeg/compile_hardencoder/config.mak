...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-cross-compile --target-os=linux --arch=arm --cross-prefix=/E/code/qiyi/forwindows/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi- --extra-cflags='-mfpu=neon  --sysroot=/E/code/qiyi/forwindows/android-ndk-r8b/platforms/android-8/arch-arm -I/E/code/qiyi/android/android4.0/frameworks/base/include -I/E/code/qiyi/android/android4.0/system/core/include -I/E/code/qiyi/android/android4.0/frameworks/base/media/libstagefright -I/E/code/qiyi/android/android4.0/hardware/libhardware/include -I/E/code/qiyi/android/android4.0/frameworks/base/include/media/stagefright/openmax -I/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/system/include -I/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/include -I/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/include -I/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/include/tr2 -I/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/libs/armeabi-v7a/include -mfloat-abi=softfp -fPIC' --disable-logging --enable-gpl --enable-version3 --enable-nonfree --disable-doc --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-postproc --enable-small --enable-fastdiv --disable-encoders --disable-decoders --enable-decoder=png --enable-decoder=h264 --enable-decoder=h263 --enable-decoder=h263i --enable-decoder=mpeg4 --enable-decoder=mjpeg --enable-decoder=jpeg2000 --enable-decoder=pcm_s16le --enable-decoder=zlib --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=aasc --enable-decoder=ac3 --enable-decoder=mp3 --enable-decoder=amrnb --enable-decoder=amrwb --enable-encoder=aac --enable-encoder=ac3 --enable-encoder=h263 --enable-encoder=pcm_s16le --enable-encoder=mjpeg --enable-encoder=jpeg2000 --enable-encoder=png --enable-encoder=zlib --disable-hwaccels --disable-muxers --disable-demuxers --enable-demuxer=mov --enable-demuxer=applehttp --enable-demuxer=h263 --enable-demuxer=h264 --enable-demuxer=mpegts --enable-demuxer=concat --enable-demuxer=aac --enable-demuxer=ac3 --enable-demuxer=amr --enable-demuxer=mp3 --enable-demuxer=image2 --enable-demuxer=image2pipe --enable-demuxer=mjpeg --enable-demuxer=pcm_s16le --enable-muxer=ac3 --enable-muxer=adts --enable-muxer=h264 --enable-muxer=image2 --enable-muxer=mjpeg --enable-muxer=mp4 --enable-muxer=mpegts --enable-muxer=mov --enable-muxer=tgp --enable-muxer=pcm_s16le --enable-muxer=rawvideo --disable-parsers --enable-parser=h264 --enable-parser=aac --enable-parser=aac_latm --enable-parser=ac3 --enable-parser=h263 --enable-parser=mjpeg --enable-parser=mpeg4video --enable-parser=mpegvideo --enable-parser=mpegaudio --disable-protocols --enable-protocol=applehttp --enable-protocol=http --enable-protocol=tcp --enable-protocol=udp --enable-protocol=concat --enable-protocol=file --enable-protocol=pipe --disable-filters --enable-filter=abuffer --enable-filter=abuffersink --enable-filter=aconvert --enable-filter=aformat --enable-filter=amerge --enable-filter=amovie --enable-filter=aresample --enable-filter=color --enable-filter=copy --enable-filter=crop --enable-filter=fade --enable-filter=fifo --enable-filter=format --enable-filter=lutrgb --enable-filter=movie --enable-filter=negate --enable-filter=overlay --enable-filter=pad --enable-filter=scale --enable-filter=select --enable-filter=thumbnail --enable-filter=transpose --enable-filter=unsharp --enable-filter=volume --disable-decoder=vp8 --disable-devices --disable-debug --disable-stripping --disable-bzlib --enable-asm --enable-sram --enable-pthreads --extra-ldflags='-L/E/code/qiyi/forwindows/android-ndk-r8b/platforms/android-8/arch-arm/usr/lib /E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/libs/armeabi-v7a/libsupc++.a  /E/code/qiyi/forwindows/android-ndk-r8b/platforms/android-8/arch-arm/usr/lib/libstdc++.a -nostartfiles  /E/code/qiyi/forwindows/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/lib/gcc/arm-linux-androideabi/4.6.x-google/libgcc.a -lstdc++ -L/E
/code/qiyi/android/android4.0/lib -Wl,-rpath-link,/E/code/qiyi/android/android4.0/lib -L/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/libs/armeabi-v7a' --extra-cxxflags='-Wno-multichar -fno-exceptions -fno-rtti -lstdc++ -lstlport -lcutils -lstagefright -lbinder -lc -lm -lz -ldl -llog -lstdc++ -lz' --enable-neon
prefix=/usr/local
...
ARCH=arm
CC=/E/code/qiyi/forwindows/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc
CXX=/E/code/qiyi/forwindows/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-g++
AS=/E/code/qiyi/forwindows/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc
LD=/E/code/qiyi/forwindows/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc
DEPCC=/E/code/qiyi/forwindows/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/E/code/qiyi/forwindows/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-ar
RANLIB=/E/code/qiyi/forwindows/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=echo skipping strip
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC
CFLAGS= -mfpu=neon --sysroot=/E/code/qiyi/forwindows/android-ndk-r8b/platforms/android-8/arch-arm -I/E/code/qiyi/android/android4.0/frameworks/base/include -I/E/code/qiyi/android/android4.0/system/core/include -I/E/code/qiyi/android/android4.0/frameworks/base/media/libstagefright -I/E/code/qiyi/android/android4.0/hardware/libhardware/include -I/E/code/qiyi/android/android4.0/frameworks/base/include/media/stagefright/openmax -I/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/system/include -I/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/include -I/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/include -I/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/include/tr2 -I/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/libs/armeabi-v7a/include -mfloat-abi=softfp -fPIC  -std=c99 -fomit-frame-pointer -fPIC -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
CXXFLAGS= -Wno-multichar -fno-exceptions -fno-rtti -lstdc++ -lstlport -lcutils -lstagefright -lbinder -lc -lm -lz -ldl -llog -lstdc++ -lz -D__STDC_CONSTANT_MACROS
ASFLAGS= -mfpu=neon --sysroot=/E/code/qiyi/forwindows/android-ndk-r8b/platforms/android-8/arch-arm -I/E/code/qiyi/android/android4.0/frameworks/base/include -I/E/code/qiyi/android/android4.0/system/core/include -I/E/code/qiyi/android/android4.0/frameworks/base/media/libstagefright -I/E/code/qiyi/android/android4.0/hardware/libhardware/include -I/E/code/qiyi/android/android4.0/frameworks/base/include/media/stagefright/openmax -I/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/system/include -I/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/include -I/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/include -I/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/include/tr2 -I/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/libs/armeabi-v7a/include -mfloat-abi=softfp -fPIC  -fPIC
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS= -L/E/code/qiyi/forwindows/android-ndk-r8b/platforms/android-8/arch-arm/usr/lib /E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/libs/armeabi-v7a/libsupc++.a /E/code/qiyi/forwindows/android-ndk-r8b/platforms/android-8/arch-arm/usr/lib/libstdc++.a -nostartfiles /E/code/qiyi/forwindows/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/lib/gcc/arm-linux-androideabi/4.6.x-google/libgcc.a -lstdc++ -L/E/code/qiyi/android/android4.0/lib -Wl,-rpath-link,/E/code/qiyi/android/android4.0/lib -L/E/code/qiyi/forwindows/android-ndk-r8b/sources/cxx-stl/gnu-libstdc++/4.6/libs/armeabi-v7a -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
...
!CONFIG_QCOM264_DECODER=yes
!CONFIG_SAMSUNG264_DECODER=yes
...
!CONFIG_LIBQCOMH264_DECODER=yes
!CONFIG_LIBSAMSUNGH264_DECODER=yes
CONFIG_LIBQCOMH264_ENCODER=yes
CONFIG_LIBSAMSUNGH264_ENCODER=yes
CONFIG_LIBSTAGEFRIGHT_ICS_ENCODER=yes
CONFIG_LIBX264_ENCODER=yes
CONFIG_LIBX264RGB_ENCODER=yes
CONFIG_LIBFDKAAC_ENCODER=yes
...
VCODEC_TESTS=amv cljr dnxhd_720p_10bit flashsv2 h263 h263p jpeg2000 ljpeg mjpeg mpng msvideo1 prores qtrle qtrlegray v210 vref zlib zmbv 
LAVF_TESTS=caf dpx jpg mov png rso sox ts voc_s16 wtv 
