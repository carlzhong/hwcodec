...
{
	//__android_log_print(ANDROID_LOG_INFO, "tt", "aac_decode_init");
                                ...
                                int *got_frame_ptr, GetBitContext *gb)
{
	...
	//__android_log_print(ANDROID_LOG_INFO, "tt", "aac_decode_frame_int is %lld,%d,%d,%d", avctx->channel_layout,\
		//                    avctx->sample_rate,avctx->channels,avctx->frame_size);
	...
	//__android_log_print(ANDROID_LOG_INFO, "tt", "aac_decode_frame_int1");
    ...
    while ((elem_type = get_bits(gb, 3)) != TYPE_END) {
        ...
        if (elem_type < TYPE_DSE) {
            ...
            samples = 1024;
			//__android_log_print(ANDROID_LOG_INFO, "tt", "aac_decode_frame_int2 is %d", elem_id);
        }

		//__android_log_print(ANDROID_LOG_INFO, "tt", "aac_decode_frame_int3 is %d", elem_type);
		...
		//__android_log_print(ANDROID_LOG_INFO, "tt", "aac_decode_frame_int4 is %d", err);
		...
		//__android_log_print(ANDROID_LOG_INFO, "tt", "aac_decode_frame_int5");
    }
	//__android_log_print(ANDROID_LOG_INFO, "tt", "aac_decode_frame_int2");
	...
	//__android_log_print(ANDROID_LOG_INFO, "tt", "aac_decode_frame_int3");
                            ...
                            int *got_frame_ptr, AVPacket *avpkt)
{
    ...
    const uint8_t *new_extradata = av_packet_get_side_data(avpkt,
                                       ...
                                       &new_extradata_size);
	//__android_log_print(ANDROID_LOG_INFO, "tt", "aac_decode_frame0");
	...
	//__android_log_print(ANDROID_LOG_INFO, "tt", "aac_decode_frame");

    if ((err = aac_decode_frame_int(avctx, data, got_frame_ptr, &gb)) < 0)
        return err;
	//__android_log_print(ANDROID_LOG_INFO, "tt", "aac_decode_frame1");
	...
	//__android_log_print(ANDROID_LOG_INFO, "tt", "aac_decode_frame2");
...
{
	//__android_log_print(ANDROID_LOG_INFO, "tt", "latm_decode_init");
