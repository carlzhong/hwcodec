                            ...
                            uint8_t *frame, int buf_size, void *data)
{
	...
	//__android_log_print(ANDROID_LOG_INFO, "tt", "aac_encode_frame");
    do {
        int frame_bits;
		...
		//__android_log_print(ANDROID_LOG_INFO, "tt", "out1 is %d,%d", s->channels,frame_bits);
        if (frame_bits <= 6144 * s->channels - 3) {
            s->psy.bitres.bits = frame_bits / s->channels;
			//__android_log_print(ANDROID_LOG_INFO, "tt", "out is %d,%d", s->channels,frame_bits);
            break;
        }
	...
	//__android_log_print(ANDROID_LOG_INFO, "tt", "aac_encode_frame1");
