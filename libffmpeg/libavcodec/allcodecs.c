...
void avcodec_register_all(void)
{
	...
	REGISTER_DECODER (LIBQCOMH264, qcom264);//carlzhong
	REGISTER_DECODER (LIBSAMSUNGH264, samsung264);//carlzhong 
	REGISTER_ENCODER (LIBQCOMH264, qcom264);//carlzhong 
	REGISTER_ENCODER (LIBSAMSUNGH264, samsung264);//CONFIG_LIBSAMSUNGH264_ENCODER
	REGISTER_ENCODER (LIBFDKAAC,libfdk_aac);
	REGISTER_ENCODER (LIBSTAGEFRIGHT_ICS,libstagefright_ics_h264);
