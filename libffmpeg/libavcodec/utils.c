...
int attribute_align_arg avcodec_open2(AVCodecContext *avctx, AVCodec *codec, AVDictionary **options)
{
	...
	//__android_log_print(ANDROID_LOG_INFO, "tt", "avcodec_open2 %d",ret);
    ...
    if (!codec)
        codec = avctx->codec;
	//__android_log_print(ANDROID_LOG_INFO, "tt", "avcodec_open22 %d",ret);
	...
	//__android_log_print(ANDROID_LOG_INFO, "tt", "avcodec_open222 %d",ret);
	...
	//__android_log_print(ANDROID_LOG_INFO, "tt", "avcodec_open2222 %d",ret);
    ...
    if ((ret = av_opt_set_dict(avctx, &tmp)) < 0)
        goto free_and_end;
	//__android_log_print(ANDROID_LOG_INFO, "tt", "avcodec_open22 %d,%d,%d",ret,codec->capabilities & CODEC_CAP_EXPERIMENTAL,\
...
#define SANE_NB_CHANNELS 128U
	...
	//__android_log_print(ANDROID_LOG_INFO, "tt", "avcodec_open211 %d",ret);
	...
	//__android_log_print(ANDROID_LOG_INFO, "tt", "avcodec_open2221 %d",ret);
#if FF_API_ER
	...
	//__android_log_print(ANDROID_LOG_INFO, "tt", "avcodec_open2211 %d",ret);
	...
	//__android_log_print(ANDROID_LOG_INFO, "tt", "avcodec_open211 %d,%d",ret,avctx->codec->init);
    ...
    //__android_log_print(ANDROID_LOG_INFO, "tt", "avcodec_open2112 %d",ret);
    ret=0;
end:
    entangled_thread_counter--;
