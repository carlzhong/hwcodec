...
ARCH=arm
CC=/D/sourceCode/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc
CXX=/D/sourceCode/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-g++
AS=/D/sourceCode/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc
LD=/D/sourceCode/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc
DEPCC=/D/sourceCode/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/D/sourceCode/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-ar
RANLIB=/D/sourceCode/android-ndk-r8b/toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=echo skipping strip
CPPFLAGS= -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600
CFLAGS= -mfpu=neon -mfloat-abi=softfp -fPIC  -std=c99 -fomit-frame-pointer -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -mfpu=neon -mfloat-abi=softfp -fPIC 
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS= -L/D/sourceCode/android-ndk-r8b/platforms/android-8/arch-arm/usr/lib -nostdlib -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
...
LAVF_TESTS=caf dpx jpg mov rso sox ts voc_s16 wtv 
